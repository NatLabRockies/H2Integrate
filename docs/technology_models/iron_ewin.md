...
None. The `cost_year` is automatically set to 2018 to match the Stinn/Allanore source values. Be sure to set `target_dollar_year` in the `finanace_parameters` to match your desired output dollar year in the finance calcluations.
