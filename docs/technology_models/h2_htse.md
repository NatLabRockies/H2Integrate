...
This matches the current HTSE configuration used in the nuclear-coupled example.

```yaml
technologies:
  htse:
    performance_model:
      model: HTSEPerformanceModel
    cost_model:
      model: HTSECostModel
    model_inputs:
      performance_parameters:
        nominal_heat_required: 6.4  # kWh/kg
        nominal_electricity_required: 36.8  # kWh/kg
        cluster_rating_MW: 1
        n_clusters: 25
        turndown_ratio: 0.1
      cost_parameters:
        unit_capex: 1295  # USD/kW
        fixed_capex: null
```

For a coupled example using thermal nuclear input, see [examples/99_nuclear_reactor_htse/tech_config.yaml](../../examples/99_nuclear_reactor_htse/tech_config.yaml).

## API Reference

```{eval-rst}
.. autoclass:: h2integrate.converters.hydrogen.htse_electrolyzer.HTSEElectrolyzerPerformanceModelConfig
   :members:
   :undoc-members:
   :show-inheritance:
   :no-index:
...
```{eval-rst}
.. autoclass:: h2integrate.converters.hydrogen.htse_electrolyzer.HTSEPerformanceModel
   :members:
   :undoc-members:
   :show-inheritance:
   :no-index:
...
```{eval-rst}
.. autoclass:: h2integrate.converters.hydrogen.htse_electrolyzer.HTSECostModelConfig
   :members:
   :undoc-members:
   :show-inheritance:
   :no-index:
...
```{eval-rst}
.. autoclass:: h2integrate.converters.hydrogen.htse_electrolyzer.HTSECostModel
   :members:
   :undoc-members:
   :show-inheritance:
   :no-index:
