...
def test_system_order(subtests):
    ...
    expected_names = [
        "wind",
        "wind_to_combiner_cable_passthrough",
        "solar",
        "solar_to_combiner_cable_passthrough",
        "combiner",
        "combiner_to_elec_combiner_cable_passthrough",
        "combiner_to_battery_cable_passthrough",
        "battery",
        "battery_to_elec_combiner_cable_passthrough",
        "elec_combiner",
        "elec_combiner_to_electrolyzer_cable_passthrough",
        "electrolyzer",
        "electrolyzer_to_h2_combiner_pipe_passthrough",
        "electrolyzer_to_h2_storage_pipe_passthrough",
        "h2_storage",
        "h2_storage_to_h2_combiner_pipe_passthrough",
        "h2_combiner",
        "steel",
