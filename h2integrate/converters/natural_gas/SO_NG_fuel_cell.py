...
class SONGFuelCellPerformanceModel(PerformanceModelBaseClass):
    ...
    def compute(self, inputs, outputs):
        ...
        rated_ng_consumed_mmbtu_per_hr = (rated_ng_consumed / mcf_to_kg) * (3600 / self.dt)
        rated_heat_out = rated_ng_consumed_mmbtu_per_hr * self.config.hhv - rated_power_production
        # in kW
