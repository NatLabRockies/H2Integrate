...
from h2integrate.converters.steel.steel import SteelPerformanceModel
...
def tech_config():
    config = {
        "model_inputs": {
            "performance_parameters": {"plant_capacity_mtpy": 8760, "capacity_factor": 0.9}
        }
    }
    return config
