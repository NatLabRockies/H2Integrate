...
- Updates `h2integrate/core/file_utils.py::check_data_dir` to allow for the creation of nested directories, not just the final subdirectory for smoother initialization of a feedstock directory.
