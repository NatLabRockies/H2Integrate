...
def test_plm_optimized_dispatch_example(subtests, temp_copy_of_example):
    ...
    with subtests.test("Check total energy charged"):
        ...
        assert pytest.approx(total_energy_charged, rel=1e-3) == -9721.0858
